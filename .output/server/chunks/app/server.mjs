import { hasInjectionContext, inject, reactive, getCurrentInstance, ref, toRef, onServerPrefetch, createApp, unref, useSSRContext, provide, onErrorCaptured, createVNode, resolveDynamicComponent, shallowRef, shallowReactive, isReadonly, defineAsyncComponent, isRef, isShallow, isReactive, toRaw, mergeProps, nextTick, defineComponent, h, Suspense, Transition } from 'vue';
import { f as useRuntimeConfig$1, m as withQuery, n as hasProtocol, p as parseURL, o as isScriptProtocol, j as joinURL, i as createError$1, q as hash, $ as $fetch, r as sanitizeStatusCode, t as defu, v as createHooks } from '../nitro/node-server.mjs';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-78dbb4ab.mjs').then((m) => m.default || m)
  },
  {
    name: "post-slug",
    path: "/post/:slug()",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_slug_-5cbcdb14.mjs').then((m) => m.default || m)
  }
];
...
const sanity_image_vKpJaOen8u = /* @__PURE__ */ defineNuxtPlugin(() => {
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "container" }, _attrs))}><header class="header"><a class="header__title" href="/">Hartmag</a></header><main>`);
      _push(ssrRenderComponent(_component_NuxtPage, null, null, _parent));
      _push(`</main><footer class="footer"><p> © ${ssrInterpolate(unref(year))} Hartmag. All Rights Reserved. Various trademarks held by their respective owners. </p></footer></div>`);
    };
  }
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-404-73d8ede3.mjs').then((r) => r.default || r));
    const _Error = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-500-e168f164.mjs').then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/island-renderer-ceb08a05.mjs').then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
...
export { useSanityQuery as a, useRoute as b, createError as c, entry$1 as default, navigateTo as n, useRouter as u };
